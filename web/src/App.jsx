...
const PHASES = [
  { label: "Origin", time: "Phase 1", color: "#00ffaa", title: "First Signs of Life", summary: "Canvas rendering. Starfield. Glow effects. Movement trail. Particle absorption. Score HUD.", systems: ["Canvas renderer", "Keyboard input", "Particle spawner", "Starfield", "Score HUD", "Absorption VFX", "Pixel glow"], complexity: 3, comparable: "Browser toy", loc: "~1.5K" },
  { label: "Prototype", time: "Phase 2", color: "#33ffbb", title: "Core Mechanics", summary: "Enemy AI with chase behavior. Absorption field. Difficulty scaling. Score streaks. Combo chains. Stage evolution.", systems: ["Enemy AI", "Absorption field", "Difficulty scaling", "Score streaks", "Combo chains", "Stage evolution", "Grid environment"], complexity: 8, comparable: "Game jam entry", loc: "~4K" },
  ...
  { label: "Forge", time: "Phase 4", color: "#66ddff", title: "Visual Engine", summary: "Offscreen compositor. Bloom pipeline. CRT scanline effects. Dynamic lighting. Parallax depth. Screen-space distortion.", systems: ["Bloom pipeline", "CRT post-process", "Dynamic lighting", "Offscreen compositor", "Parallax layers", "Distortion FX", "Screen shake"], complexity: 35, comparable: "Geometry Wars quality", loc: "~15K" },
  { label: "Alpha", time: "Phase 5", color: "#88ff88", title: "Game Content", summary: "Shield mechanic. Boss encounters. Health system with death/respawn. Environmental hazards. Nebula backgrounds. Mini-map.", systems: ["Shield mechanic", "Boss system", "Health system", "Death/respawn", "Nebula effect", "Orbit particles", "Hazards", "Mini-map"], complexity: 50, comparable: "Arcade game", loc: "~25K" },
  { label: "Crucible", time: "Phase 6", color: "#ffcc44", title: "Sound & Game Feel", summary: "Web Audio synthesis for SFX. Hitpause on impacts. Screen transitions. Combat feedback. Controls tutorial overlay.", systems: ["Audio engine", "Synthesized SFX", "Hitpause", "Screen transitions", "Combat system", "Controls hints"], complexity: 65, comparable: "Polished indie", loc: "~35K" },
  { label: "Beta", time: "Phase 7", color: "#ff8844", title: "Content Depth", summary: "Enemy variety. Boss projectile attacks. Health bars. Particle physics. Endless scaling. Planned: leaderboard, achievements.", systems: ["Boss projectiles", "Health bars", "Particle physics", "Endless mode", "Planned: Leaderboard", "Planned: Achievements", "Planned: Pause menu"], complexity: 80, comparable: "Steam-ready indie", loc: "~50K" },
  { label: "Release", time: "Phase 8", color: "#ff4488", title: "Launch Ready", summary: "Planned: mobile touch controls, tutorial flow, auto-quality, end-of-run stats, loading screen, social sharing.", systems: ["Planned: Touch controls", "Planned: Tutorial", "Planned: Auto-quality", "Planned: Stats screen", "Planned: Loading screen", "Planned: Social sharing"], complexity: 95, comparable: "Published indie game", loc: "~60K+" },
];

const DIMENSIONS = [
  { name: "Gameplay Depth", icon: "🎮", realism: 88, ceiling: "Boss fights with projectile attacks, combo chains, shield mechanics, absorption combat, stage evolution, environmental hazards, endless scaling. Currently live: boss encounters, enemy AI, absorption field combat, 9-stage evolution.", bottleneck: "Design coherence across 45+ autonomous modules. Each module is independent — emergent interactions need tuning." },
  { name: "Visual Fidelity", icon: "🎨", realism: 85, ceiling: "Canvas 2D pushed to its limits: offscreen compositing, bloom pipeline, dynamic lighting, CRT post-processing, parallax depth layers, screen-space distortion. All currently live.", bottleneck: "Performance at 60fps with 300+ entities, lighting, and post-processing. Needs auto-quality system for low-end hardware." },
  { name: "Audio & Music", icon: "🎵", realism: 78, ceiling: "Procedural audio via Web Audio API. Currently live: synthesized SFX for combat, shields, bosses, evolution. Next: generative ambient music that reacts to gameplay intensity.", bottleneck: "Generative music that sounds GOOD. Synthesis is easy — emotional resonance takes iteration." },
  { name: "Game Feel", icon: "✨", realism: 92, ceiling: "Hitpause on impacts, screen shake, temporal slowdown, combat feedback particles, evolution flash effects. Currently live and working.", bottleneck: "Subtlety. Each effect must enhance without distracting. 20 juice effects that each feel right is harder than 1." },
  ...
  { name: "Engine Quality", icon: "🏗️", realism: 90, ceiling: "ECS architecture, spatial hash collisions, camera system, render layers, state machine, delta-time normalization. All currently live.", bottleneck: "Module integration. Each system built independently must compose correctly with all others." },
  { name: "Polish", icon: "💎", realism: 60, ceiling: "Planned: title screen, tutorial flow, settings, achievements, high scores, loading screen, social sharing, mobile touch controls. Not yet built.", bottleneck: "UI polish is iterative. Each screen needs to feel right. Canvas-rendered UI (no HTML) adds complexity." },
  { name: "Accessibility", icon: "♿", realism: 40, ceiling: "Planned: color-blind modes, screen shake intensity slider, particle density options, auto-quality for low-end devices. Not yet built.", bottleneck: "Testing across devices and needs. Requires dedicated accessibility pass after core gameplay stabilizes." },
];
